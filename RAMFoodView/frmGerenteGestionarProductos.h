...
namespace RAMFoodView {
	...
	/// <summary>
	/// Summary for frmGerenteGestionarProductos1
	/// </summary>
	public ref class frmGerenteGestionarProductos1 : public System::Windows::Forms::Form
	{
	public:
		frmGerenteGestionarProductos1(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"frmGerenteGestionarProductos1";
