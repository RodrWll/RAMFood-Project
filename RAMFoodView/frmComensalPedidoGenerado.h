...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(68, 36);
			this->label2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(232, 44);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Su comida llegará automáticamente a la mesa, no retire nada de la faja por favor";
			...
			this->label1->Location = System::Drawing::Point(67, 16);
